...
const telurian2 = [
    {
        ...
        itemDescription: ['The tracklist features  four parts (OPUS 1-4) listing 38 tracks from 48 artists, surfing the electronic', 'minimal music in every direction as the perfect soundtrack for your trips this new season!', 'The download link includes the graphics and the album in WAV format.','€29,99'],
        delivery: `You'll receive a download link once PayPal confirms your payment.`,
        morePhotos: null,
        soldOut: false,
    },
